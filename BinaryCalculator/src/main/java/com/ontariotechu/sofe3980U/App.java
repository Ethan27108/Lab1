...
public class App 
{
	...
	*/
    public static void main( String[] args )
    {
		...
		System.out.println( "Their summation is "+or.getValue());
        Binary and= Binary.AND(binary1,binary2);
		System.out.println( "Their summation is "+and.getValue());
        Binary mult= Binary.Multiply(binary1,binary2);
		System.out.println( "Their summation is "+mult.getValue());
